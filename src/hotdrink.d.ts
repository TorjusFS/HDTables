...
export interface Graph<VertexDescriptor, EdgeDescriptor> {
  ...
  export interface Labels<VertexDescriptor,
    EdgeDescriptor,
    VertexLabel,
    EdgeLabel>
    extends VertexLabels<VertexDescriptor, VertexLabel>,
  ...
  export interface AssignableLabels<VertexDescriptor,
    EdgeDescriptor,
    VertexLabel,
    EdgeLabel>
  ...
  export interface GrowableGraph<VertexDescriptor,
    EdgeDescriptor,
    VertexLabel,
    EdgeLabel> extends Graph<VertexDescriptor, EdgeDescriptor> {
  ...
  export interface ModifiableGraph<VertexDescriptor,
    EdgeDescriptor,
    VertexLabel,
    EdgeLabel>
    extends GrowableGraph<VertexDescriptor,
      EdgeDescriptor,
      VertexLabel,
      EdgeLabel>,
  ...
  export function orderedSetEquals<Key, Value, M extends Set<Key> | Map<Key, Value>>(s1: M, s2: M): boolean;
  
  export function orderedMapEquals<Key, Value, M extends Map<Key, Value>>(s1: M, s2: M): boolean;
  
  export function setEquals<Key, Value, M extends Set<Key> | Map<Key, Value>>(s1: M, s2: M): boolean;
  
  export function mapEquals<Key, Value, M extends Map<Key, Value>>(s1: M, s2: M): boolean;
  
  export function copy<T>(a: T): T;
  
  export function subsetOf<Key, Value, M extends Set<Key> | Map<Key, Value>>(sub: M, sup: M): boolean;
  
  export function modifyMapValue<Key, Value>(m: Map<Key, Value>, k: Key, fn: (arg0: Value | null | undefined) => Value): Value;
  ...
  export function iteratorToIterable<T, U, V>(it: /*$*/Iterator<T, U, V>): /*$*/Iterable<T/*, U, V*/>;
  
  export function iterableToIterator<T, U, V>(it: /*$*/Iterable<T/*, U, V*/>): /*$*/Iterator<T, U, V>;
  
  export function map<T, U>(fn: (arg0: T) => U, iterable: Iterable<T>): Iterable<U>;
  
  export function filter<T>(fn: (arg0: T) => boolean, iterable: Iterable<T>): Iterable<T>;
  
  export function until<T>(fn: (...args: Array<any>) => any, iterable: Iterable<T>): Iterable<T>;
  
  export function every<T>(fn: (arg0: T) => boolean, iterable: Iterable<T>): boolean;
  
  export function some<T>(fn: (arg0: T) => boolean, iterable: Iterable<T>): boolean;
  
  export function forEach<T, U>(fn: (arg0: T) => U, iterable: Iterable<T>): (arg0: T) => U;
  
  export function adjacentFind<T, U, V>(cmp: (arg0: T, arg1: T) => boolean, iterable: /*$*/Iterable<T/*, U, V*/>): [T, T] | null | undefined;
  
  export function isSortedBy<T>(cmp: (arg0: T, arg1: T) => boolean, iterable: Iterable<T>): boolean;
  ...
  export function foldl<T, U>(fn: (arg0: T, arg1: U) => U, u: U, iterable: Iterable<T>): U;
  
  export function join<T>(it1: Iterable<Iterable<T>>): Iterable<T>;
  
  export function zipWith<T, U, A>(fn: (arg0: T, arg1: U) => A, it1: Iterable<T>, it2: Iterable<U>): Iterable<A>;
  ...
  export function every2<T, U>(fn: (arg0: T, arg1: U) => boolean, it1: Iterable<T>, it2: Iterable<U>): boolean;
  ...
  export function mkRefCounted<T extends {}>(o: T, disposer: (arg0: T) => any, uniqueHandler?: (arg0: T) => any): T;
  
  export function setUniqueHandler<T extends {}>(o: T, uniqueHandler: (arg0: T) => any): void;
  ...
  export declare class ListNode<T> {
    ...
    constructor(p: ListNode<T> | null | undefined, n: ListNode<T> | null | undefined, d: T)
  }
  ...
  declare class AdjacencyList<VertexDescriptor, VertexLabel, EdgeLabel> {
    ...
    edge(source: VertexDescriptor, target: VertexDescriptor): EdgeDescriptorT<VertexDescriptor> | null | undefined;
    ...
    addEdge(src: VertexDescriptor, target: VertexDescriptor, l: EdgeLabel | null | undefined): EdgeDescriptorT<VertexDescriptor>;
  
    addVertex(l: VertexLabel | null | undefined): VertexDescriptor;
  
    addVertexDescriptor(v: VertexDescriptor, l: VertexLabel | null | undefined): VertexDescriptor;
    ...
    private _setEdgeLabel(s: VertexDescriptor, t: VertexDescriptor, l: EdgeLabel): void;
  }
  
  declare class AdjacencyListOpaqueDescriptors<VertexLabel, EdgeLabel> extends AdjacencyList<vertex_descriptor, VertexLabel, EdgeLabel> {
    private _fresh: vertex_descriptor;
  
    addVertex(l: VertexLabel | null | undefined): vertex_descriptor;
  
    addVertexDescriptor(v: vertex_descriptor, l: VertexLabel | null | undefined): vertex_descriptor;
  }
  ...
  declare class EvaluationGraph implements BidirectionalAdjacencyIteration<eg_vertex_descriptor> {
  ...
  export declare class ConstraintSpec {
  ...
  export declare class VariableReference<T> extends ObservableReference<Variable<T>> {
  ...
  export declare class DownstreamSolutionGraph implements AdjacencyIteration<sg_vertex_descriptor> {
  ...
  export declare class UpstreamSolutionGraph implements AdjacencyIteration<sg_vertex_descriptor> {
    private _system: ConstraintSystem;
  ...
  export function sat(predicate: (arg0: string) => boolean, name?: string): NamedParser<string>;
  ...
  export function lift<T>(f: (...vs: any) => T, ...parsers: Array<Parser<any>>): Parser<T>;
  
  export function lift2<T1, T2, U>(f: (arg0: T1, arg1: T2) => U): (arg0: Parser<T1>, arg1: Parser<T2>) => Parser<U>;
  
  export function lift3<T1, T2, T3, U>(f: (arg0: T1, arg1: T2, arg2: T3) => U): (arg0: Parser<T1>, arg1: Parser<T2>, arg2: Parser<T3>) => Parser<U>;
  
  export function lift4<T1, T2, T3, T4, U>(f: (arg0: T1, arg1: T2, arg2: T3, arg3: T4) => U): (arg0: Parser<T1>, arg1: Parser<T2>, arg2: Parser<T3>, arg3: Parser<T4>) => Parser<U>;
  
  export function lift5<T1, T2, T3, T4, T5, U>(f: (arg0: T1, arg1: T2, arg2: T3, arg3: T4, arg4: T5) => U): (arg0: Parser<T1>, arg1: Parser<T2>, arg2: Parser<T3>, arg3: Parser<T4>, arg4: Parser<T5>) => Parser<U>;
  
  export function go<T>(pg: Generator<Parser<any>, T, any>): Parser<T>;
  
  export function inBetween<T, U, V>(p: Parser<T>, open: Parser<U>, close: Parser<V>): Parser<T>;
  ...
  export function notFollowedBy<T, U>(q1: NamedParser<T>, q2: NamedParser<U>): Parser<T>;
  ...
  export function sepList<Element, Sep>(element: Parser<Element>, sep: Parser<Sep>): Parser<Array<Element>>;
  ...
  export declare class PeekIterator<T, CheckpointData> {
